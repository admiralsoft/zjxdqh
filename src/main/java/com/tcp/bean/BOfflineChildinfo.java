 ...
 */
@Table(name = "b_offline_childinfo")
public class BOfflineChildinfo implements java.io.Serializable{
	...
	private BigDecimal chargingServicePrice ;
	...
	private BigDecimal chargingServiceamount ;
	...
	public BigDecimal getChargingServicePrice() {
		return chargingServicePrice;
	}

	public void setChargingServicePrice(BigDecimal chargingServicePrice) {
	...
	public BigDecimal getChargingServiceamount() {
		return chargingServiceamount;
	}

	public void setChargingServiceamount(BigDecimal chargingServiceamount) {
