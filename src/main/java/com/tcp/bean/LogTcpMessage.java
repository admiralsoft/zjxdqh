 ...
 */
@Table(name = "log_tcp_message")
public class LogTcpMessage implements java.io.Serializable{
	...
	/** 报文命令 **/
	@Column(name="message_cmd")
	private Integer messageCmd ; 
	...
	public Integer getMessageCmd() {
		return messageCmd;
	}
	public void setMessageCmd(Integer messageCmd) {
